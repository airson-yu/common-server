...
import cc.airson.common.server.config.BaseTip;
import cc.airson.common.server.datasource.DynamicDataSourceHolder;
...
public class ExceptionCheck {
    ...
    public static void check_business_exception (Exception ex, JSONObject json) {
        String msg = json.getString(BaseTip.key_msg);
        String code = json.getString(BaseTip.key_code);
        /*if (ex instanceof com.zom.common.exception.CmsException) {
